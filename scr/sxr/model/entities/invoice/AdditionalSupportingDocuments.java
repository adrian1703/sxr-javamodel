...
public class AdditionalSupportingDocuments extends SxrObject {
	/* =========== Basic Properties   =========== */
	@XmlAttribute( term = "schemeID", btRef = "null", type = Object.class, parent = "invoicedObjectIdentifierSupportingDocumentReference")
	public Object invoicedObjectIdentifierSupportingDocumentReference_schemeID;
